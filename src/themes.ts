...
export const COLOR_THEMES: ColorTheme[] = [
  ...
  // },
  {
    ...
    primary: '#e8d5b7',
    secondary: '#c4a77d',
    borderGlow: 'rgba(196, 167, 125, 0.4)',
    textDim: 'rgba(232, 213, 183, 0.65)',
    accent: '#d4a574',
    matrixHead: '#c4a77d',
    matrixBody: '#b8956e',
    matrixDim: 'rgba(184, 149, 110, 0.4)',
  },
  // {
  ...
  //   matrixHead: '#ffffff',
  //   matrixBody: '#b0b0b0',
  //   matrixDim: 'rgba(176, 176, 176, 0.4)',
  // },
  // {
  //   name: 'concentration',
  //   primary: '#8b9da8',
  //   secondary: '#6b7d88',
  //   borderGlow: 'rgba(107, 125, 136, 0.25)',
  //   textDim: 'rgba(139, 157, 168, 0.55)',
  //   accent: '#7a8c97',
  //   matrixHead: '#6b7d88',
  //   matrixBody: '#5c6d78',
  //   matrixDim: 'rgba(92, 109, 120, 0.25)',
  // },
  // {
  //   name: 'green',
  //   primary: '#00ff88',
